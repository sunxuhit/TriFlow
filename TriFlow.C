...
void TriFlow(const Char_t *inputFile="/project/projectdirs/star/xusun/OutPut/AuAu39GeV/List/run_list/39GeV_511.list", const Int_t jobCounter = 511, const Int_t Mode = 6, const Int_t energy = 1)
