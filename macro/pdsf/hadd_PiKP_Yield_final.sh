...
if [ $# -eq 0 ]
  then
    PID=Proton
    Energy=200GeV
    OutDir="/project/projectdirs/starprod/rnc/xusun/OutPut/AuAu$Energy/Mass2_$PID/Yields/merged_file/Yield_${Energy}_"
    suffix=".root"
    ...
    do
      ...
      do
	echo -n "$yields " >> run_hadd_final_${PID}_Yields_$counter.csh
      done
