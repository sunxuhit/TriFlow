#ifndef AMPT_res_CMW_h
#define AMPT_res_CMW_h
#include "StMessMgr.h"
#include "TString.h"
...
class AMPT_res_CMW // TODO: change the Tree structure
{
  public:
    AMPT_res_CMW(Int_t Energy, Int_t Mode, Int_t Screen, Int_t List, Long64_t StartEvent, Long64_t StopEvent); // read in energy, AMPT mode, data list, StartEvent and StopEvent
    ~AMPT_res_CMW();
