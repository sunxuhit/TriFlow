...
#############################Mixed_Event#################################
      ...
      qsub -hard -l scratchfree=500,h_cpu=24:00:00,h_vmem=1.8G,projectio=1 -o /project/projectdirs/star/xusun/OutPut/AMPT_StringMelting/Log/run$Name$counter$suffix.log -e /project/projectdirs/star/xusun/OutPut/AMPT_StringMelting/Log/run$Name$counter$suffix.err ./run$Name$counter$suffix.csh

      mv run$Name$counter$suffix.csh /project/projectdirs/star/xusun/OutPut/AMPT_StringMelting/Script/
    done
