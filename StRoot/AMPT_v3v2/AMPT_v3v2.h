...
{
  public:
    AMPT_v3v2(Int_t Energy, Int_t List, Long64_t StartEvent, Long64_t StopEvent); // read in energy, data list, StartEvent and StopEvent
    ~AMPT_v3v2();
  ...
  private:
    ...
    static Int_t mRefMult[7][10]; // centrality definition
