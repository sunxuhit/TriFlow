...
{
    Float_t pA[2] = {path_in_A+2.0,path_in_A-2.0};
    Float_t pB[2] = {path_in_B+2.0,path_in_B-2.0}; // the two start values for pathB, 0.0 is the origin of the helix at the first measured point
    Float_t distarray[2];
...
{
    Float_t pA[2] = {path_in_A+2.0,path_in_A-2.0}; // the two start values for pathB, 0.0 is the origin of the helix at the first measured point
    Float_t distarray[2];
