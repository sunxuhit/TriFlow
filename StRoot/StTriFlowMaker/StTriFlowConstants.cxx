...
// phi-Psi bin
Float_t TriFlow::phi_Psi2_low[7] = {0,TMath::Pi()/14,2*TMath::Pi()/14,3*TMath::Pi()/14,4*TMath::Pi()/14,5*TMath::Pi()/14,6*TMath::Pi()/14};
Float_t TriFlow::phi_Psi2_up[7]  = {TMath::Pi()/14,2*TMath::Pi()/14,3*TMath::Pi()/14,4*TMath::Pi()/14,5*TMath::Pi()/14,6*TMath::Pi()/14,7*TMath::Pi()/14};
Float_t TriFlow::phi_Psi3_low[7] = {0,TMath::Pi()/21,2*TMath::Pi()/21,3*TMath::Pi()/21,4*TMath::Pi()/21,5*TMath::Pi()/21,6*TMath::Pi()/21};
Float_t TriFlow::phi_Psi3_up[7]  = {TMath::Pi()/21,2*TMath::Pi()/21,3*TMath::Pi()/21,4*TMath::Pi()/21,5*TMath::Pi()/21,6*TMath::Pi()/21,7*TMath::Pi()/21};

Float_t TriFlow::Psi2_low[3] = {-3*TMath::Pi()/2,-1*TMath::Pi()/2,1*TMath::Pi()/2};
Float_t TriFlow::Psi2_up[3]  = {-1*TMath::Pi()/2, 1*TMath::Pi()/2,3*TMath::Pi()/2};
Float_t TriFlow::Psi3_low[5] = {-4*TMath::Pi()/3,-3*TMath::Pi()/3,-1*TMath::Pi()/3,1*TMath::Pi()/3,3*TMath::Pi()/3};
Float_t TriFlow::Psi3_up[5]  = {-3*TMath::Pi()/3,-1*TMath::Pi()/3, 1*TMath::Pi()/3,3*TMath::Pi()/3,4*TMath::Pi()/3};
