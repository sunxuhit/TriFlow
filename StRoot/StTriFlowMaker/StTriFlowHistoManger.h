...
class StTriFlowHistoManger
{
  public:
    ...
    void FillHist(Float_t pt, Int_t Cent9, Int_t charge_bin, Int_t eta_gap, Float_t phi_psi2, Float_t Res2, Float_t phi_psi3, Float_t Res3, Float_t New_X, Float_t New_Y, Double_t reweight, Int_t i_cut);
    ...
    void FillYields_PiK(Int_t Cent9, Int_t charge_bin, Int_t eta_gap, Float_t New_X, Float_t New_Y, Double_t reweight, Int_t i_cut);
...
//    TH2F *h_mMass2_nSigmaPion_Yields_PiK_EP[9][2][4];
    TH2FMap h_mMass2_nSigmaPion_Yields_PiK_EP;
