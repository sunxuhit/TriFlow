...
class AMPT_CMW // TODO: change the Tree structure
{
  public:
    AMPT_CMW(Int_t Energy, Int_t Mode, Int_t Screen, Int_t List, Long64_t StartEvent, Long64_t StopEvent); // read in energy, AMPT mode, data list, StartEvent and StopEvent
    ~AMPT_CMW();
